...
import (
	...
	assets_storage "github.com/Ferum-Bot/HermesTrade/internal/scrappers/coinbase/client/assets-storage"
	"github.com/Ferum-Bot/HermesTrade/internal/scrappers/coinbase/client/coinbase"
	assets_storage_sender "github.com/Ferum-Bot/HermesTrade/internal/scrappers/coinbase/services/assets-storage-sender"
	"github.com/Ferum-Bot/HermesTrade/internal/scrappers/coinbase/services/converter"
	"github.com/Ferum-Bot/HermesTrade/internal/scrappers/coinbase/services/parser"
	"github.com/Ferum-Bot/HermesTrade/internal/scrappers/coinbase/workers/scrapper"
...
func main() {
	...
	exchangeClient := coinbase.NewClient()
	...
	go func() {
		log.Infof("Coinbase Scrapper worker started")
	...
	go func() {
		log.Infof("Coinbase Scrapper metrics server started")
	...
	<-done
	log.Infof("Coinbase Scrapper is stopping")
	...
	log.Infof("Coinbase Scrapper stopped")
}
